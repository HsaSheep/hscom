...
#bossbar設定
function hsfunc:werewolf_test/timer/bossbar/remove
schedule function hsfunc:werewolf_test/timer/bossbar/set 1t append

#update呼出
schedule function hsfunc:werewolf_test/timer/update/update 1s append