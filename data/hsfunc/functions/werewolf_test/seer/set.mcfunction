...
execute if entity @a[scores={player_id=1}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~ Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
#Player2
...
execute if entity @a[scores={player_id=2}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~2 Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
#Player3
...
execute if entity @a[scores={player_id=3}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~4 Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
#Player4
...
execute if entity @a[scores={player_id=4}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~6 Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
#Player5
...
execute if entity @a[scores={player_id=5}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~8 Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
#Player6
...
execute if entity @a[scores={player_id=6}] at @e[tag=DummyPlayer,tag=Seer,limit=1] run data modify block ~5 ~ ~10 Text4 set value '{"text":"< 右クリックで占う >","clickEvent":{"action":"run_command","value":"function hsfunc:werewolf_test/seer/run"}}'
