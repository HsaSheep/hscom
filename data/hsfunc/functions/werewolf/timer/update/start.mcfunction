...
function hsfunc:werewolf/timer/bossbar/set
#tellraw @s ["",{"text":"---タイマー停止---","color":"dark_red","clickEvent":{"action":"run_command","value":"/function hsfunc:werewolf/timer/done"}}]
#タイマー開始
...
function hsfunc:werewolf/timer/update/countdown
