...
#効果音再生
function hsfunc:werewolf/timer/update/done_sound
schedule function hsfunc:werewolf/timer/update/done_sound 2t append
schedule function hsfunc:werewolf/timer/update/done_sound 4t append
