...
tellraw @a[tag=posi_check_tag,limit=1] ["",{"text": " 1.ショップ地点は"},{"score":{"name": "@a[tag=posi_check_tag,limit=1]","objective": "check_count"}},{"text": "箇所設定済み"}]
#shop
scoreboard players set @a[tag=posi_check_tag,limit=1] check_count 0
execute as @e[tag=ww_isolate_position] run scoreboard players add @a[tag=posi_check_tag,limit=1] check_count 1
tellraw @a[tag=posi_check_tag,limit=1] ["",{"text": " 2.隔離地点は"},{"score":{"name": "@a[tag=posi_check_tag,limit=1]","objective": "check_count"}},{"text": "/1箇所設定済み"}]
#shop
scoreboard players set @a[tag=posi_check_tag,limit=1] check_count 0
execute as @e[tag=ww_game_position] run scoreboard players add @a[tag=posi_check_tag,limit=1] check_count 1
tellraw @a[tag=posi_check_tag,limit=1] ["",{"text": " 3.ゲーム地点は"},{"score":{"name": "@a[tag=posi_check_tag,limit=1]","objective": "check_count"}},{"text": "/1箇所設定済み"}]
