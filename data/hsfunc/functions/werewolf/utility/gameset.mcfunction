...
execute if entity @a[tag=wwp,tag=mani] as @e[tag=game,limit=1] run tellraw @a[tag=wwps] ["",{"text":"["},{"selector":"@s"},{"text":"] "},{"text":"-- ","color":"white"},{"text":"狂人","color":"gold"},{"text":" : ","color":"white"},{"score":{"name":"@e[tag=game,limit=1]","objective":"r_mani"},"color":"white"},{"text":" --","color":"white"}]
execute if entity @a[tag=wwp,tag=mani] as @a[tag=wwp,tag=mani] run tellraw @a[tag=wwps] ["",{"text":"            "},{"selector":"@s","color":"gold"}]
execute if entity @a[tag=wwp,tag=drac] as @e[tag=game,limit=1] run tellraw @a[tag=wwps] ["",{"text":"["},{"selector":"@s"},{"text":"] "},{"text":"-- ","color":"white"},{"text":"吸血","color":"dark_purple"},{"text":" : ","color":"white"},{"score":{"name":"@e[tag=game,limit=1]","objective":"r_drac"},"color":"white"},{"text":" --","color":"white"}]
...
execute as @e[tag=wwp,tag=!wolf,tag=!mani,tag=!drac] run tellraw @a[tag=wwps] ["",{"text":"            "},{"selector":"@s","color":"green"}]
##プレイ時間表示
