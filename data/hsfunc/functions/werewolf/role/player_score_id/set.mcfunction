...
execute if entity @a[gamemode=creative,tag=wPlayer,scores={player_id=0},limit=1] run tag @a[gamemode=creative,tag=wPlayer,scores={player_id=0},limit=1] add pidset
