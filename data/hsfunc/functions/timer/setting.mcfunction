...
#タイマー設定を表示
give @s written_book{title:"タイマー設定",author:"",pages:['[{"text":"-----タイマー開始-----\\n","color":"dark_red","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/update/start"}},{"text":"\\n+ 1分\\n","color":"dark_green","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/set/add_60"}},{"text":"+30秒\\n","color":"dark_green","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/set/add_30"}},{"text":"-30秒\\n","color":"dark_green","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/set/rem_30"}},{"text":"- 1分\\n","color":"dark_green","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/set/rem_60"}},{"text":"\\n----Debug:3秒設定----\\n","color":"light_purple","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/set/set_3"}},{"text":"\\n-----タイマー再開-----\\n","color":"gold","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/update/resume"}},{"text":"-----タイマー停止-----\\n","color":"gold","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/update/stop"}},{"text":"\\n-----タイマー削除-----","color":"dark_red","clickEvent":{"action":"run_command","value":"/function hsfunc:timer/update/setting_remove"}}]']}