...
#効果音再生
function hsfunc:timer/update/done_sound
schedule function hsfunc:timer/update/done_sound 2t append
schedule function hsfunc:timer/update/done_sound 4t append
